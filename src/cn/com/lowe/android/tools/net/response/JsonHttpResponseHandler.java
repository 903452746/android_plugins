 ...
 */
public abstract class JsonHttpResponseHandler extends HttpResponseHandler {
	
	protected abstract void onSuccess(int statusCode, Header[] headers, JSONObject response);

	protected abstract void onSuccess(int statusCode, Header[] headers, JSONArray response);
	...
	protected void onSuccess(int statusCode, Header[] headers, Object content) {
		if (statusCode != HttpStatus.SC_NO_CONTENT) {
			...
			try {
				jsonResponse = parseResponse((String)content);
	...
	private Object parseResponse(String content) throws JSONException {
